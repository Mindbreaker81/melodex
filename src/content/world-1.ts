  ...
  steps: [
    {
      ...
      image: "/illustrations/lesson-1/intro.svg",
      imageAlt: "Teclado con grupos de dos y tres teclas negras resaltados.",
      visualHint: "group-2-3",
    },
    {
      id: "lesson-1-s2",
      type: "intro",
      ...
      image: "/illustrations/lesson-1/intro.svg",
      imageAlt: "Detalle del teclado mostrando el grupo de dos teclas negras.",
      visualHint: "group-2-3",
    },
    {
      id: "lesson-1-s3",
  ...
  steps: [
    {
      ...
      image: "/illustrations/lesson-2/intro.svg",
      imageAlt: "Teclado con la nota Do señalada a la izquierda de dos teclas negras.",
      visualHint: "find-c",
    },
    {
      id: "lesson-2-s2",
  ...
  steps: [
    {
      ...
      image: "/illustrations/lesson-3/intro.svg",
      imageAlt: "Cinco teclas blancas consecutivas marcadas como Do, Re, Mi, Fa y Sol.",
      visualHint: "scale-up",
    },
    {
      id: "lesson-3-s2",
